    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="blogApp.location.home.createOrEditLabel">
              ...
              <AvForm model={isNew ? {} : locationEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="streetAddressLabel" for="streetAddress">
                    <Translate contentKey="blogApp.location.streetAddress">Street Address</Translate>
                  </Label>
                  <AvField id="location-streetAddress" type="text" name="streetAddress" />
                </AvGroup>
                <AvGroup>
                  <Label id="postalCodeLabel" for="postalCode">
                    <Translate contentKey="blogApp.location.postalCode">Postal Code</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label id="stateProvinceLabel" for="stateProvince">
                    <Translate contentKey="blogApp.location.stateProvince">State Province</Translate>
                  </Label>
                  <AvField id="location-stateProvince" type="text" name="stateProvince" />
                </AvGroup>
                <AvGroup>
                  <Label for="country.id">
                    <Translate contentKey="blogApp.location.country">Country</Translate>
                  </Label>
