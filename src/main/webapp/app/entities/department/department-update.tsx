    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="blogApp.department.home.createOrEditLabel">
              <Translate contentKey="blogApp.department.home.createOrEditLabel">Create or edit a Department</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : departmentEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="departmentNameLabel" for="departmentName">
                    <Translate contentKey="blogApp.department.departmentName">Department Name</Translate>
                  </Label>
                  <AvField
                ...
                <AvGroup>
                  <Label for="location.id">
                    <Translate contentKey="blogApp.department.location">Location</Translate>
                  </Label>
