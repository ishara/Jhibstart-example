    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="blogApp.country.home.createOrEditLabel">
              <Translate contentKey="blogApp.country.home.createOrEditLabel">Create or edit a Country</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : countryEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="countryNameLabel" for="countryName">
                    <Translate contentKey="blogApp.country.countryName">Country Name</Translate>
                  </Label>
                  <AvField id="country-countryName" type="text" name="countryName" />
                </AvGroup>
                <AvGroup>
                  <Label for="region.id">
                    <Translate contentKey="blogApp.country.region">Region</Translate>
                  </Label>
