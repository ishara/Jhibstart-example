    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="blogApp.task.home.createOrEditLabel">
              <Translate contentKey="blogApp.task.home.createOrEditLabel">Create or edit a Task</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : taskEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="titleLabel" for="title">
                    <Translate contentKey="blogApp.task.title">Title</Translate>
                  </Label>
                  <AvField id="task-title" type="text" name="title" />
                </AvGroup>
                <AvGroup>
                  <Label id="descriptionLabel" for="description">
                    <Translate contentKey="blogApp.task.description">Description</Translate>
                  </Label>
