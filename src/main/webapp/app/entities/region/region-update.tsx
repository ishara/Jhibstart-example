    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="blogApp.region.home.createOrEditLabel">
              <Translate contentKey="blogApp.region.home.createOrEditLabel">Create or edit a Region</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : regionEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="regionNameLabel" for="regionName">
                    <Translate contentKey="blogApp.region.regionName">Region Name</Translate>
                  </Label>
